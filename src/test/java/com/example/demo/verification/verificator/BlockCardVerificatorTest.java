...
public class BlockCardVerificatorTest {
    @Autowired
    ...
    public void createCardVerificatorTest() {
        ...
        AbstractVerificator verificator = verificatorAbstractFactory.getBlockCardVerificator(VerificationType.EMAIL);
        assertEquals(verificator.getClass(), BlockCardVerificator.class);

        RequestOrder blockCardTransfer = requestFactory.createBlockCardRequest(cardService, "0");
        String id = verificator.startVerification(blockCardTransfer);
