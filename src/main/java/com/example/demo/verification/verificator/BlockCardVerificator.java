...
public class BlockCardVerificator extends AbstractVerificator{

    public BlockCardVerificator(VerificationStrategy verificationStrategy, VerificationService verificationService) {
    ...
    public String startVerification(RequestOrder requestOrder) {
        ...
        String message = "you are trying to block card validation code: " + verificationObject.getCode();
